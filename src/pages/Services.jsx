...
export default function Services() {
  ...
  const [quoteFormData, setQuoteFormData] = useState({
    name: '',
    phone: '',
    requirementType: 'Construction Services',
  ...
  const servicesList = [
    {
      ...
      desc: "We specialize in sourcing a diverse range of construction professionals, from blue-collar laborers to highly qualified engineers. Our extensive network includes carpenters, masons, helpers, scaffolders, welders, electricians, site engineers etc. all of whom are carefully vetted to ensure they possess the skills and experience necessary to contribute effectively to your projects. Whether you're working on a residential build, a commercial construction project, or infrastructure development, we have the right people for every role."
    },
    {
      id: 2,
      ...
      desc: "Need someone to oversee your construction project? Our project managers are experts in coordinating teams, managing budgets, and ensuring that projects are completed on time and within scope. We also offer flexible staffing solutions, providing both temporary and permanent personnel to meet the demands of your project. Our goal is to ensure that you have the right staff at the right time, whether it's for a short-term surge or long-term roles."
    },
    {
      id: 3,
      ...
      desc: "Navigating the legal landscape of labor laws and regulations in the construction industry can be daunting. Our team of experts ensures that your workforce complies with all statutory requirements, including Provident Fund (PF), Employee State Insurance (ESI), and labor welfare. We also provide safety and compliance staffing to ensure that your construction site meets all regulatory requirements and maintains the highest safety standards. We keep you updated with the latest legal developments and handle all necessary documentation, so you can focus on delivering outstanding projects."
    },
    {
      id: 4,
      ...
      desc: "Managing payroll for a construction workforce can be complex, particularly when dealing with large teams and diverse job roles. At Bhavika Manpower, we take the hassle out of payroll management. We handle all aspects of payroll processing, ensuring your workers are paid accurately and on time. We also manage the intricacies of overtime, allowances, and deductions, providing a seamless and stress-free payroll process that allows you to focus on your core business."
    }
  ]

  // 4 Industries We Serve Data
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col justify-between font-sans antialiased text-slate-800">
      ...
      <section className="relative h-56 sm:h-64 md:h-72 bg-slate-900 text-white flex items-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          ...
          <div className="flex items-center gap-2 text-xs sm:text-sm font-semibold text-slate-300">
            ...
            <span className="text-[#00a2ed]">Services</span>
          </div>
        </div>
      </section>

      {/* 3. OUR SERVICES SECTION (2x2 Grid with Clean White Background) */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-10">
            {servicesList.map((service) => (
              ...
              >
                ...
                {/* Title */}
                <h3 className="font-heading font-bold text-lg sm:text-xl text-slate-900 mb-3 leading-snug">
                  {service.title}
                </h3>
      ...
      {/* 4. INDUSTRIES WE SERVE SECTION (2x2 Grid) */}
      ...
      {/* 6. FOOTER (MATCHED TO REFERENCE IMAGE) */}
            ...
            {quoteSubmitted ? (
              ...
              <form onSubmit={handleQuoteSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  >
                    <option value="Construction Services">Construction Manpower & Project Management</option>
                    <option value="Temporary & Contract Staffing">Temporary & Project-Based Hiring</option>
                    <option value="Compliance & Legal Assurance">Compliance & Legal Assurance</option>
                    <option value="Payroll Management">Payroll Management Services</option>
                  </select>
                </div>
